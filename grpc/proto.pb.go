...
func (x *ChitChat) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChitChat) ProtoMessage() {}

func (x *ChitChat) ProtoReflect() protoreflect.Message {
	mi := &file_proto_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use ChitChat.ProtoReflect.Descriptor instead.
func (*ChitChat) Descriptor() ([]byte, []int) {
	return file_proto_proto_rawDescGZIP(), []int{0}
}

func (x *ChitChat) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *ChitChat) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *ChitChat) GetLamportTimestamp() int64 {
	if x != nil {
...
const file_proto_proto_rawDesc = "" +
	...
	"\x11lamport_timestamp\x18\x03 \x01(\x03R\x10lamportTimestamp2:\n" +
	"\fChatDatabase\x12*\n" +
	"\fChitChatting\x12\t.ChitChat\x1a\t.ChitChat\"\x00(\x010\x01B\x16Z\x14ITUServer/grpc/protob\x06proto3"
...
var file_proto_proto_goTypes = []any{
	(*ChitChat)(nil), // 0: ChitChat
}
var file_proto_proto_depIdxs = []int32{
	0, // 0: ChatDatabase.ChitChatting:input_type -> ChitChat
	0, // 1: ChatDatabase.ChitChatting:output_type -> ChitChat
